//Mutex is used to avoid race condition and define critical sections of code which need
//synchronous access
package main
...
//incCounter function increments the package level Counter variable
